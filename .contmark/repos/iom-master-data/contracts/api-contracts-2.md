---category: contracts
title: API contracts — part 2
summary: Documented HTTP routes for sales, vendors, diesel price ranges, and vessel domains.
primary_for: [api-contract-index-extended]
mentions: [http, routes, vendors, vessel, sales]
scenarios:
  - list vendor routes
  - inspect vessel contract
  - see sales api
  - see diesel api
  - find batch lookup route
